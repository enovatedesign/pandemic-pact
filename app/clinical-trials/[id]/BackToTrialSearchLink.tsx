...
// The search this returns to — query, filters and active tab — is restored from
// the Explore page's own stored state, so this link carries nothing itself.
export default function BackToTrialSearchLink() {
    return (
        <Link
            href="/clinical-trials/explore"
