    ...
    return (
        <>
            <animated.div id={id} ref={ref} style={springs}>
                <div className="visualisation-card-wrapper flex flex-col items-start gap-y-6 h-full w-full bg-white p-6 lg:p-10 border-y-2 border-gray-200 lg:rounded-xl lg:border-2 relative overflow-visible">
                    <div className="flex flex-col items-start gap-y-6">
                        ...
                        {numberOfActiveFilters > 0 && (
                            <div className='absolute top-0 right-0 bg-red-transparent aspect-square w-full h-28 lg:rounded-tr-xl border-2 border-transparent translate-x-0.5 -translate-y-0.5 overflow-hidden'>
