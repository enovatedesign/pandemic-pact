                    ...
                    <div className="flex flex-col gap-6 bg-white p-6 lg:p-12 rounded-2xl border-2 border-gray-200">
                        ...
                        <div className="my-2 breakout-with-border overflow-hidden">
                            <div className="relative flex flex-col lg:flex-row justify-start items-center w-full bg-secondary md:rounded-2xl overflow-hidden">
                                <h3
                                    className={`self-start lg:self-auto px-4 py-2 lg:py-0 lg:px-4 text-white tracking-wider lg:[writing-mode:vertical-lr] ${titleClasses}`}
                                >
                                    Key facts
                                </h3>
                                <div className="w-full bg-primary text-secondary">
                                        ...
                                        {filteredKeyFactsHeadings.map(
                                            (heading, index) => {
                                                const borderClasses = [
                                                    ...
                                                    index === 2 &&
                                                        "md:border-r-2 md:col-span-3",
                                                    index === 3 &&
                                                        "border-r-2 md:col-span-3 md:border-r-0",
                                                    index === 4 &&
                                                        "md:col-span-2 md:border-r-2",
                                                    index === 5 &&
                                    ...
                                    <ul className="grid grid-cols-2 md:grid-cols-3 bg-primary-lightest">
                                        {keyFactsSubHeadings.map(
                                            (subHeading, index) => {
                                                const borderClasses = [
                                                    index === 0 &&
                                                        "border-r-2 md:border-r-2",
                                                    index === 2 &&
