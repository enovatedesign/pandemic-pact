                            ...
                            <div className="max-w-3xl mx-auto flex flex-col gap-4">
                                ...
                                <small>
                                    ...
                                    <p className="hidden lg:block text-center text-white/60 text-pretty">
                                        All visualizations and data produced by Pandemic PACT are open access under the <Link href="https://creativecommons.org/licenses/by/4.0/" className="underline" target="_blank" rel="license noopener noreferrer">Creative Commons BY license</Link>. You have permission to use, distribute, and reproduce these in any medium, provided the source and authors are credited as per the <Link href="https://www.pandemicpact.org/about/overview" className="underline" target="_blank" rel="license noopener noreferrer">citation</Link>. All the software and code that we write is open source and made available via <Link href="https://github.com/enovatedesign/pandemic-pact" className="underline" target="_blank" rel="license noopener noreferrer">GitHub</Link> under the MIT license.
                                    </p>
                                </small>
                            </div>
