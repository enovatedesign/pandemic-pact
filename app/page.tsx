...
import "./css/components/masthead.css"
...
export default function Home() {
    ...
    const btnClasses = "flex justify-center px-10 py-3 rounded-full border border-primary/25 inner-glow uppercase text-center text-white font-medium tracking-wider text-xl"

    return (
        <>
            <NavigationMenu />

            <InteractiveBackground className="relative w-screen h-screen masthead-background">
