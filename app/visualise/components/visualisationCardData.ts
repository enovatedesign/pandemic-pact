...
export const visualisationCardData = (outbreak: boolean = false, disease: string = ''): VisualisationCardDataProps[] => [
    {
        title: "Disease",
        summary: {
    ...
    {
        title: 'Research & Policy Roadmaps',
        summary: {
        ...
        url: {
            ...
            "default": '/grants/visualise/policy-roadmaps',
...
export const hundredDaysMissionJumpCardData: VisualisationCardDataProps[] = [
    {
...
export const pandemicIntelligenceJumpCardData: VisualisationCardDataProps[] = [
    {
        title: 'Research themes',
        summary: {
            "default": 'Charts showing grants by WHO Pandemic and Epidemic Intelligence priority themes'
        },
        url: {
    ...
    },
    {
        title: 'Pathogen',
        summary: {
            "default": 'Explore grants by Pandemic and Epidemic Intelligence theme and pathogen family'
        },
        url: {
            "default": '#research-priority-themes-by-pathogen'
        },
        image: {
            url: `/images/visualisation-cards/vis-bar-chart.svg`,
            altText: 'Illustration of a bar chart',
    ...
    },
    {
        title: 'Geographical distribution',
        summary: {
            "default": 'Charts showing the location of funding organisations and where the funding flows to support research activities. Charts can be visualised at the level of WHO regions or individual countries.'
        },
        url: {
            "default": '#geographical-distribution'
        },
    ...
    },
    {
        title: 'Funders',
        summary: {
            "default": 'Charts showing the funders of grants focusing on Pandemic and Epidemic Intelligence'
        },
        url: {
            "default": '#pandemic-epidemic-funders'
        },
        image: {
            url: `/images/visualisation-cards/vis-implementation-and-access.svg`,
            altText: '',
    ...
    },
    {
        title: 'Annual trends',
        summary: {
            "default": 'Charts for trends in research funding for grants focusing on Pandemic and Epidemic Intelligence priorities'
        },
        url: {
            "default": '#annual-trends-in-new-grants-by-theme'
        },
        image: {
            url: `/images/visualisation-cards/vis-line-chart.svg`,
            altText: 'Illustration of a line chart',
            width: 480,
            height: 480,
        },
