...
import Pathogen from './visualisations/Pathogen'
                ...
                >
                    ...
                    >
                        <div className={`${gridClasses} mt-6`}>
                            <div id="clinical-research-grants">
                            ...
                            <div id="geographical-distribution">
                                <GeographicalDistribution />
                            </div>

                            <div id="implementation-and-access">
